...
function Paragraph() {
  ...
  I just told you! You've killed me! Fry! Quit doing the right thing, you jerk! Michelle, I don't regret this, but I both rue and lament it. Morbo can't understand his teleprompter because he forgot how you say that letter that's shaped like a man wearing a hat.`,
    ...
    const handlesubmit=(e)=>{
      ...
      setText(textt.slice(0,amount))
}

  return (
    <>
  <section className='section-center '>   
<center><h3 className='pt-5'> TIRED OF BORING LOREM IPSUM?</h3></center>

<form onSubmit={handlesubmit}> 
  <div className='text-center'>  <i> Paragraph: </i> <input 
  type='number'
  name='amount'
  id='amount'
  value={count}
  ...
  <center><button className = 'btn fw-bold bg-info mt-3 ms-5 '><h3>Generate</h3></button></center>
</form>
<article>
  {
    text.map((item,index)=>{
